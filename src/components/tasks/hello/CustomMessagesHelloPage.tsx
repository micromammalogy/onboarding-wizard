...
const PAGE_OPTIONS = [
  { label: 'Default', value: 'hello_default' },
  { label: 'Home page', value: 'hello_homepage' },
  { label: 'Product list', value: 'hello_item_list' },
  { label: 'Product detail', value: 'hello_item_details' },
  { label: 'Cart', value: 'hello_cart' },
] as const;
...
export const CustomMessagesHelloPage = () => {
  ...
  const currentPageName = PAGE_OPTIONS[activeTab]?.value || 'hello_default';
  ...
  return (
    ...
    >
      ...
      >
        <Text type="title">Hello Custom Messages</Text>
      ...
      <p style={{ margin: 0, fontSize: 14, color: 'var(--amino-gray-500)' }}>
        Create custom translated messages that appear on different pages where
        Zonos Hello is active on your site.
      </p>
